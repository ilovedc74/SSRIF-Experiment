...
<body>
<form action="/~whitney/exp3old/surveybasic.php" id="usrform" method="post">
  <div><p>
    <br>
...
<col style="width: 147px">
  ...
  <tr>
    <td class="tg-s4a2">1. 在與其他受試者討論的過程中，平均而言我覺得緊張。</td>
  ...
  <tr>
    <td class="tg-qsvf">2. 在與其他受試者討論的過程中，平均而言我能專注。</td>
